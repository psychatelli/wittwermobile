...
class FCL_Active_Tracking extends Component {
  render() {
    ...
    return (
      <Container style={styles.container_white}>
        ...
        <Text style={styles.header_2}>TRACKING</Text>
          ...
          <TrackingLayout shipment={this.props.FCL_active_reducer} />   
          </View>
        </Content>
      </Container>
    );
...
export default connect(mapStateToProps, matchDispatchToProps)(FCL_Active_Tracking);