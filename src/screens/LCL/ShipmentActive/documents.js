...
class LCL_Active_Documents extends Component {
  render() {
      ...
      <Container style={styles.container_white}>
          ...
          <Text style={styles.header_2}>DOCUMENTS</Text>
            ...
            <View style={styles.custom_wrapper}>
              <DocumentsLayout shipment={this.props.LCL_active_reducer} />   
              </View>
          </Content>
      </Container>
    );
...
export default connect(mapStateToProps, matchDispatchToProps)(LCL_Active_Documents);