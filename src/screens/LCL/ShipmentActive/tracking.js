...
class LCL_Active_Tracking extends Component {
  render() {
    ...
    return (
      <Container style={styles.container_white}>
        ...
        <Text style={styles.header_2}>TRACKING</Text>
          ...
          <TrackingLayout shipment={this.props.LCL_active_reducer} />   
          </View>
        </Content>
      </Container>
    );
...
export default connect(mapStateToProps, matchDispatchToProps)(LCL_Active_Tracking);